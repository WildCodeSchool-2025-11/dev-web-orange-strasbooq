        ...
        >
            <nav className="m-auto pr-[20px] flex gap-4">
                <p className="text-white absolute left-5 bottom-5">
                    © 2024 Strasbooq. All rights reserved.</p>
                ...
                <RouterLink to="/Contact" className="text-white absolute right-5 bottom-5 mt-5">
                    Contact
                </RouterLink>
                <RouterLink to="/Adresse" className="text-white absolute right-5 bottom-15 mt-5">
                    Adresse
                </RouterLink>
            </nav>
